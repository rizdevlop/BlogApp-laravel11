            ...
            <div class="card mini-stat bg-primary text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase text-white-50">ARTIKEL</h5>
                    </div>
                    <div class="pt-2">
                        <div class="float-end">
                            <a href="/posts-management" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                        </div>
            ...
            <div class="card mini-stat bg-success text-white">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <h5 class="font-size-16 text-uppercase text-white-50">PESAN MASUK</h5>
                    </div>
                    <div class="pt-2">
                        <div class="float-end">
