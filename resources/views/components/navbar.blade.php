<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <img class="h-8 w-8" src="{{ asset('images/blog.png') }}" alt="Your Company">
            </div>
            <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <x-nav-link href="/artikel-posts" :active="request()->is('artikel-posts')">Blog</x-nav-link>
            ...
            <div class="relative ml-3">
                ...
                <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    @php
                        $user = auth()->user();
                    @endphp
                    <img class="h-8 w-8 rounded-full" src="{{ $user->profile_photo ? asset('profile_user/' . $user->profile_photo) : asset('images/img-default.png') }}" alt="">
                </button>
                </div>
    ...
    <div x-show='isOpen' class="md:hidden" id="mobile-menu">
        ...
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="/artikel-posts" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Blog</a>
        ...
        <div class="flex items-center px-5">
            ...
            @php
                $user = auth()->user();
            @endphp
            <img class="h-10 w-10 rounded-full" src="{{ $user->profile_photo ? asset('profile_user/' . $user->profile_photo) : asset('images/img-default.png') }}" alt="">
            </div>
            <div class="ml-3">
